      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            // Tombol Call
            ElevatedButton(
              onPressed: _mahasiswaInput != null
                  ? () async {
                      final kontak = _mahasiswaInput!.kontak.toString();
                      final Uri telUri = Uri(scheme: 'tel', path: kontak);
                      if (await canLaunchUrl(telUri)) {
                        await launchUrl(
                          telUri,
            ...
            if (_mahasiswaInput != null) ...[
              const SizedBox(height: 16),
              Text("Data Mahasiswa:"),
              Text("Nama: ${_mahasiswaInput!.nama}"),
              Text("Umur: ${_mahasiswaInput!.umur}"),
              Text("Alamat: ${_mahasiswaInput!.alamat}"),
              Text("Kontak: ${_mahasiswaInput!.kontak}"),
            ],
          ],
        ),
      ),
